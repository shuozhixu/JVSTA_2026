...
atomsk --create bcc $a Nb orient [-57-2] [-3-14] [111] -duplicate 17 29 2 supercell.cfg
...
atomsk screw_Nb.cfg -select random 25636 Nb -sub Nb Mo MoNb.cfg

atomsk MoNb.cfg -select random 25636 Nb -sub Nb Ti MoNbTi.cfg lmp
