...
atomsk --create bcc $a Nb orient [-110] [-1-12] [111] -duplicate 83 60 2 supercell.cfg
...
atomsk screw_Nb.cfg -select random 19920 Nb -sub Nb Mo MoNb.cfg

atomsk MoNb.cfg -select random 19920 Nb -sub Nb Ti MoNbTi.cfg lmp
