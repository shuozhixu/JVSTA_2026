...
atomsk --create bcc $a Nb orient [-541] [-1-23] [111] -duplicate 23 40 2 supercell.cfg
...
atomsk screw_Nb.cfg -select random 25760 Nb -sub Nb Mo MoNb.cfg

atomsk MoNb.cfg -select random 25760 Nb -sub Nb Ti MoNbTi.cfg lmp
